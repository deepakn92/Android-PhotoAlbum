...
public class TagDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		album = getArguments().getString(Definitions.ALBUM_TITLE);
		photo = getArguments().getString(Definitions.PHOTO_FILENAME);
		mode = getArguments().getInt(Definitions.MODE);
							...
							switch (mode) {
								...
								case 2 :
									...
									if (ctrl.renameAlbum(TagDialogFragment.this.album, val)) {
										...
										i.putExtra(Definitions.ALBUM_TITLE, val);
										getActivity().finish();
										ctx.startActivity(i);
									}
									break;
